    ...
    <Flex height="75vh" width="full" align="center" justifyContent="center">
      ...
      <Box p={8} maxWidth="500px" borderWidth={1} borderRadius={8}>
        <Box display="flex" alignItems="center" justifyContent="center">
          <Image boxSize="75px" objectFit="cover" src={logo} mb={3} />
        </Box>
        <Box>
        ...
        <Box my={4} textAlign="left">
          <form >
            <Button type="submit" colorScheme="teal" size="md" variant="outline" width="full" mt={4} onClick={signInWithGoogle}>Sign in with Google</Button>
          </form>
          <Divider />
